...
import { useConfirmPasswordResetMutation } from "@/lib/features/auth/resetPasswordApiSlice";
...
const ResetPasswordPage: React.FC<ResetPasswordPageProps> = ({ params }: { params: { token: string } }) => {
