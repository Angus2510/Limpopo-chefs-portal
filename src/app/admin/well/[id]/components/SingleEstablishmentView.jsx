...
import { useGetWelByIdQuery, useUpdateWelMutation, useDeleteWelMutation } from '@/lib/features/wel/welApiSlice';
...
const SingleEstablishmentView = ({ id }) => {
    ...
    const handleUpdate = async () => {
        ...
        formData.append('deletePhotoPaths', JSON.stringify(establishmentData.deletePhotoPaths));
    ...
    const handleDeletePhoto = (index) => {
        const updatedPhotos = establishmentData.photos.filter((_, i) => i !== index);
        setEstablishmentData(prevState => ({
            ...prevState,
            deletePhotoPaths: [...(prevState.deletePhotoPaths || []), establishmentData.photos[index]],
            ...
            {selectedPhoto !== null && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
                    <div className="relative bg-white p-6 rounded-lg max-w-4xl mx-auto">
                        <img src={establishmentData.photos[selectedPhoto]} alt={`View ${selectedPhoto}`} className="w-full max-h-[80vh] object-contain" />
                        <button
