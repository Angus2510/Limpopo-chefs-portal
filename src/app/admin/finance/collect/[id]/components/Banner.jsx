  ...
  return (
    <Card className={"items-center w-full h-full p-[16px] bg-cover"}>
      ...
      <div className="relative mt-1 flex h-32 w-full justify-center rounded-xl bg-cover bg-[url('/img/profile/banner.png')]" >
        <div className={`absolute -bottom-12 flex h-[87px] w-[87px] items-center justify-center rounded-full border-[4px] border-white ${!avatar || imageError ? 'bg-gray-400' : 'bg-pink-400'} dark:!border-navy-700`}>
          {avatar && !imageError ? (
            <img
