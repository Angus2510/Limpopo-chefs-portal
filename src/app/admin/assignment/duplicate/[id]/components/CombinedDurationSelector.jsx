                            ...
                            <div className="h-40 overflow-y-auto hide-scrollbar">
                                {hourOptions.map(option => (
                                    <div
                                        ...
                                        className={`cursor-pointer hover:bg-gray-100 p-1 text-center ${option === hours ? 'bg-brand-200' : ''}`}
                                    >
                                        {option}
                                    </div>
                                ))}
                            ...
                            <div className="h-40 overflow-y-auto hide-scrollbar">
                                {minuteOptions.map(option => (
                                    <div
                                        ...
                                        className={`cursor-pointer hover:bg-gray-100 p-1 text-center ${option === minutes ? 'bg-brand-200' : ''}`}
                                    >
                                        {option}
                                    </div>
                                ))}
